...
if (empty($_GET['message']) === false) {
	$message=$_GET['message'];//if there is a var called message on URL- find it.
}
...
<tr>
	...
	<td width="84%">
		<input type="text" name="student_first" id="student_first" required>
	</td>
</tr>
<tr>
	<td>Last Name*</td>
	<td>
		<input type="text" name="student_last" id="student_last" required>
	</td>
</tr>
<tr>
	<td>Email*</td>
