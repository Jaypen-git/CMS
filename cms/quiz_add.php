...
if (isset($_POST['submit'])) {//if this is the second time this file loads, after a submit
	...
	<main>
		...
		<form action="" method="post" id="add_question_form">
			<table width="100%" border="0" cellspacing="10">
				...
				<tr>
					<td width="30%" height="150" align="right" valign="top">Statement</td>
					<td valign="top"><input type="text" name="question_statement" id="question_statement" required size="50" maxlength="150">
					</td>
				</tr>

				<tr>
					<td width="30%" height="150" align="right" valign="top">Correct answer</td>
					<td valign="top">
						<label>true </label>
					...
					<tr>
					<td width="30%" height="150" align="right" valign="top">Points</td>
					<td valign="top">
